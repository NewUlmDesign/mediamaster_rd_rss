...
Plugin URI: http://ulmdesign.mediamaster.eu/mediamaster_rss_reader/
Description: Reader rss for your Wordpress site based on google feed api 
Version: 1.0
License: GPL
...
function m_update_rss_options_form()
{
    ...
    <div class="wrap">
    	...
    	<form method="post" action="options.php"><?php settings_fields('mRSS_options_group'); ?>
    		...
    		<p>If you want to change color you can use search engine and type, in editbox, keyword: Color Picker CSS</p>
